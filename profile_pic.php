            ...
            if(isset($_FILES['post_img'])===true)
             ...
             ?>
                  ...
                  <div style="width: 500px;width: 500px;margin:0 auto;">
            ...
            if(isset($_GET['delete'])===true){
              ...
              echo '<h1 style="font-weight:100">'. 'profile picture deleted successfully'.'';
              else
                echo '<h1 style="font-weight:100">'. 'deletion unsuccessfull'.'';
